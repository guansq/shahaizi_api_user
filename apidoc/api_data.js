define({ "api": [
  ...
  {
    "type": "GET",
    "url": "/index.php?m=Api&c=getPackOrder&a=getPackOrder",
    "title": "得到包车订单列表（未完成）",
    "name": "getPackOrder",
    "group": "PackOrder",
    "parameter": {
    ...
    "sampleRequest": [
      {
        "url": "http://shz.api.user.ruitukeji.cn:8502/index.php?m=Api&c=getPackOrder&a=getPackOrder"
      }
    ]
  },
  {
  ...
  },
  {
    ...
    "sampleRequest": [
      {
        "url": "http://shz.api.user.ruitukeji.cn:8502/recommend/showMyRecommInfo"
      }
    ]
  },
  {
